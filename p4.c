...
c) Read edges (u, v, weight) and populate undirected graph

If choice = 2:
a) Run Prim's MST logic to find minimum weight edges
b) Display edges included in MST and the total cost
